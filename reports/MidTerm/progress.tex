...
\tightcaption{Comparison of total scripting time with and without chrome's optimisations}
\label{fig:scripting_p2}
\end{subfigure}
\begin{subfigure}[b]{0.5\textwidth}
\centering
\includegraphics[width=0.9\columnwidth]{figs/v8cache_P2_compile.pdf}
\tightcaption{Comparison of total compiling time with and without chrome's optimisations}
