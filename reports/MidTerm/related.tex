...
A recent paper from Google in 2016 \cite{vesuna2016caching} %Caching Doesn’t Improve Mobile Web Performance (Much)
...
Other client side improvements reduce energy usage and computational delays using parallel
