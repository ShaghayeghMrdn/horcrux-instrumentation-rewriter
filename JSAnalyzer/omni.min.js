  ...
  (function(definition) {
    ...
    Omni = (function() {
        ...
        try {
          ...
          result = (function() {
            ...
            switch (typeof input) {
              ...
              default:
                var _id;
                if (_id=objectToId.get(input)){
                  return JSON.stringify("__Omni_ref_" + _id);
                }
                if (Util.isArray(input)) {
                    _id = Util.d2h(this.counter++);
                  objectToId.set(input,_id);
                  // idToObject.set(_id, input);
                  // input.__Omni_id = _id;
                  arr = [];
      ...
      Omni.prototype.fixTree = function(obj) {
        ...
        if ( (typeof obj == "string") && (m = obj.match(Omni._refMatcher)) ){
            return idToObject.get(Util.h2d(m[1]));
        }
        if (Util.isArray(obj)) {
