  ...
  (function(definition) {
    ...
    Omni = (function() {
      ...
      /*
        ...
        type
      */
      Omni.prototype.stringify = function(input,state,stage) {
        try {
          ...
          var stringify = state == "read" || stage == 2 ? JSON.stringify : emptyFn; 
          ...
          if (obj && (obj.__Omni_cons != null)) {
            ...
            if (proto != null) {
              if (Util.supportsProto) {
                ...
                for (k in obj) {
                  v = obj[k];
                  if (obj.hasOwnProperty(k) && k != "__Omni_cons") {
                    t[k] = v;
                  }
                }
